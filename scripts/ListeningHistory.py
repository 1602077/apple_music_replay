...
def listening_history(input_file):
    """
    Data proccessing pipeline to remove redudant columns and filter for music streams
    only in Apple_Music_Play_Activity.csv
    """
...
if __name__ == "__main__":
    listening_history("../input_data/Apple_Music_Play_Activity.csv")
